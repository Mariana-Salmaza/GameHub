...
$url = "https://gamehub-connect.000webhostapp.com/api/equipe.php";
    ...
    ?>
            <div class="col-12 col-md-3 text-center d-flex align-items-stretch">
                <div class="card custom-photo-card" data-aos="fade-up" data-aos-delay="50">
                    <img src="<?= htmlspecialchars($membro['foto'], ENT_QUOTES, 'UTF-8') ?>" alt="<?= htmlspecialchars($membro['nome'], ENT_QUOTES, 'UTF-8') ?>" class="card-img-top img-fluid" loading="lazy">
