<?php
    ...
    "poster"=>"{$path}capa.png","banner"=>"{$path}bannerMeu.png", "capa"=>"{$path}1.png","jogo"=>"http://localhost/GameHub/games/EnemyWar/index.html");
    ...
    "poster"=>"{$path}posterDiego.png","banner"=>"{$path}bannerjogo1D.png", "capa"=>"{$path}1.png","jogo"=>"http://localhost/GameHub/games/SpaceSoldierSurvival_Diego/index.html");
    ...
    "poster"=>"{$path}posterJulio.png","banner"=>"{$path}BannerParabellumJulio.png", "capa"=>"{$path}fotoGameJ2.jpeg","jogo"=>"http://localhost/GameHub/games/Parabellum_Julio/index.html");
    ...
    "poster"=>"{$path}posterLuiz.png","banner"=>"{$path}fotojogoLuiz2.jpeg", "capa"=>"{$path}fotojogoLuiz2.jpeg","jogo"=>"http://localhost/GameHub/games/LeMinotaur_Luiz/index.html");
    ...
    "poster"=>"{$path}posterMaycon.png","banner"=>"{$path}bannerMaycon.png", "capa"=>"{$path}bannerMaycon.png","jogo"=>"http://localhost/GameHub/games/takslab_Maycon/takslab/index.html");
