<?php
    ...
    "poster"=>"{$path}capa.png","banner"=>"{$path}bannerMeu.png", "capa"=>"{$path}1.png","jogo"=>"https://gamehub-connect.000webhostapp.com/games/EnemyWar/index.html");
    ...
    "poster"=>"{$path}posterDiego.png","banner"=>"{$path}bannerjogo1D.png", "capa"=>"{$path}bannerjogoD.png","jogo"=>"https://gamehub-connect.000webhostapp.com/games/SpaceSoldierSurvival_Diego/index.html");
    ...
    "poster"=>"{$path}posterJulio.png","banner"=>"{$path}BannerParabellum.png", "capa"=>"{$path}fotoGameJ2.jpeg","jogo"=>"https://gamehub-connect.000webhostapp.com/games/Parabellum_Julio/index.html");
    ...
    "poster"=>"{$path}posterLuiz.png","banner"=>"{$path}fotojogoLuiz2.png", "capa"=>"{$path}fotojogoLuiz2.jpeg","jogo"=>"https://gamehub-connect.000webhostapp.com//games/LeMinotaur_Luiz/index.html");
    ...
    "poster"=>"{$path}posterMaycon.png","banner"=>"{$path}bannerMaycon.png", "capa"=>"{$path}bannerMaycon.png","jogo"=>"https://gamehub-connect.000webhostapp.com/games/takslab_Maycon/takslab/index.html");
