<?php
    ...
    "poster"=>"{$path}capa.png","banner"=>"{$path}bannerMeu.png", "capa"=>"{$path}foto1.png");
    ...
    "poster"=>"{$path}posterDiego.png","banner"=>"{$path}bannerjogo1D.png", "capa"=>"{$path}bannerjogoD.png");
    ...
    "poster"=>"{$path}posterJulio.png","banner"=>"{$path}BannerParabellumJulio.png", "capa"=>"{$path}fotoGameJ2.jpeg");
    ...
    "poster"=>"{$path}posterLuiz.png","banner"=>"{$path}fotojogoLuiz2.jpeg", "capa"=>"{$path}fotojogoLuiz2.jpeg");
